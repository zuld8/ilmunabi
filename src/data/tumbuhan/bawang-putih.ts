...
export const bawangPutihData: ObjectData = {
  ...
  anak: {
    ...
    facts: [
      { id: "Tumbuhan Bawang Putih melakukan fotosintesis menyerap karbon dioksida dan menghasilkan oksigen segar.", en: "Tumbuhan Bawang Putih melakukan fotosintesis menyerap karbon dioksida dan menghasilkan oksigen segar." },
      { id: "Akar, batang, dan daun Bawang Putih bekerja menyerap mineral bumi untuk menghasilkan buah atau zat penyembuh.", en: "Akar, batang, dan daun Bawang Putih bekerja menyerap mineral bumi untuk menghasilkan buah atau zat penyembuh." },
      { id: "Zat hijau daun (klorofil) pada Bawang Putih adalah laboratorium biokimia canggih ciptaan Allah SWT.", en: "Zat hijau daun (klorofil) pada Bawang Putih adalah laboratorium biokimia canggih ciptaan Allah SWT." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban sains Bawang Putih: Struktur pembuluh kayu dan tapis pada Bawang Putih mengalirkan air melawan gravitasi bumi tanpa suara, membuktikan kehebatan rekayasa biologi Allah.",
      en: "Keajaiban sains Bawang Putih: Struktur pembuluh kayu dan tapis pada Bawang Putih mengalirkan air melawan gravitasi bumi tanpa suara, membuktikan kehebatan rekayasa biologi Allah.",
    },
    quranVerse: {
