...
export const floraUnik7Data: ObjectData = {
  slug: "flora-unik-7",
  name: {
    id: "Flora Unik 7",
    en: "Flora Unik 7",
  ...
  balita: {
    text: {
      id: "Ini Flora Unik 7! Ciptaan Allah yang luar biasa indah. 🌟",
      en: "This is Flora Unik 7! An amazingly beautiful creation of Allah. 🌟",
    },
    audioTranscript: {
      id: "Ini Flora Unik 7. Allah menciptakan Flora Unik 7 dengan sangat baik agar kita semua bersyukur.",
      en: "This is Flora Unik 7. Allah created Flora Unik 7 beautifully so we all become grateful.",
    },
    quiz: {
      question: {
        id: "Mana gambar Flora Unik 7?",
        en: "Which one is the picture of Flora Unik 7?",
      },
      options: [
        { text: { id: "🌿 Flora Unik 7", en: "🌿 Flora Unik 7" } },
  ...
  anak: {
    text: {
      id: "Fakta menarik tentang Flora Unik 7: Merupakan bukti keagungan penciptaan Allah di alam semesta.",
    ...
    quiz: {
      question: {
        id: "Siapa yang menciptakan Flora Unik 7 dengan sempurna?",
        en: "Who created Flora Unik 7 perfectly?",
      },
      options: [
  ...
  explorer: {
    text: {
      id: "Eksplorasi anatomi dan struktur Flora Unik 7 mengungkap kehebatan rancangan sistem biologi dan alam yang seimbang.",
    ...
    quiz: [
      {
        question: {
          id: "Apa hikmah utama diutusnya tanda sains tentang Flora Unik 7?",
          en: "What is the primary wisdom of scientific signs regarding Flora Unik 7?",
        },
        options: [
