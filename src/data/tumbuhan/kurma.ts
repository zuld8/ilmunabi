...
export const kurmaData: ObjectData = {
  ...
  balita: {
    text: {
      id: "Ini Kurma! Ciptaan Allah yang luar biasa indah. 🌟",
      en: "This is Kurma! An amazingly beautiful creation of Allah. 🌟",
    },
    audioTranscript: {
      id: "Ini Kurma. Allah menciptakan Kurma dengan sangat baik agar kita semua bersyukur.",
      en: "This is Kurma. Allah created Kurma beautifully so we all become grateful.",
    },
    quiz: {
      question: {
        id: "Mana gambar Kurma?",
        en: "Which one is the picture of Kurma?",
      },
      options: [
        { text: { id: "🌴 Kurma", en: "🌴 Kurma" } },
  ...
  anak: {
    text: {
      id: "Fakta menarik tentang Kurma: Merupakan bukti keagungan penciptaan Allah di alam semesta.",
    ...
    quiz: {
      question: {
        id: "Siapa yang menciptakan Kurma dengan sempurna?",
        en: "Who created Kurma perfectly?",
      },
      options: [
  ...
  explorer: {
    text: {
      id: "Eksplorasi anatomi dan struktur Kurma mengungkap kehebatan rancangan sistem biologi dan alam yang seimbang.",
    ...
    quiz: [
      {
        question: {
          id: "Apa hikmah utama diutusnya tanda sains tentang Kurma?",
          en: "What is the primary wisdom of scientific signs regarding Kurma?",
        },
        options: [
