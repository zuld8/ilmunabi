...
export const pisangData: ObjectData = {
  ...
  anak: {
    ...
    facts: [
      { id: "Pisang diciptakan dengan keunikan dan manfaat yang sangat besar.", en: "Pisang was created with unique traits and immense benefits." },
      { id: "Allah menyebut Pisang dalam Al-Qur'an agar manusia mengamati sains di baliknya.", en: "Allah mentions Pisang in the Qur'an so humans observe the science behind it." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban sains dan wahyu yang sesuai: Allah menyebut Pisang di Al-Qur'an ribuan tahun sebelum sains modern meneliti keunikan fungsionalnya.",
      en: "The alignment of science and revelation: Allah mentioned Pisang in the Qur'an thousands of years before modern science researched its functional uniqueness.",
    },
    quranVerse: {
