...
export const tinData: ObjectData = {
  ...
  anak: {
    ...
    facts: [
      { id: "Tumbuhan Tin melakukan fotosintesis menyerap karbon dioksida dan menghasilkan oksigen segar.", en: "Tumbuhan Tin melakukan fotosintesis menyerap karbon dioksida dan menghasilkan oksigen segar." },
      { id: "Akar, batang, dan daun Tin bekerja menyerap mineral bumi untuk menghasilkan buah atau zat penyembuh.", en: "Akar, batang, dan daun Tin bekerja menyerap mineral bumi untuk menghasilkan buah atau zat penyembuh." },
      { id: "Zat hijau daun (klorofil) pada Tin adalah laboratorium biokimia canggih ciptaan Allah SWT.", en: "Zat hijau daun (klorofil) pada Tin adalah laboratorium biokimia canggih ciptaan Allah SWT." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban sains Tin: Struktur pembuluh kayu dan tapis pada Tin mengalirkan air melawan gravitasi bumi tanpa suara, membuktikan kehebatan rekayasa biologi Allah.",
      en: "Keajaiban sains Tin: Struktur pembuluh kayu dan tapis pada Tin mengalirkan air melawan gravitasi bumi tanpa suara, membuktikan kehebatan rekayasa biologi Allah.",
    },
    quranVerse: {
