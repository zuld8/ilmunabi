...
export const bimaSaktiData: ObjectData = {
  slug: "bima-sakti",
  name: {
  ...
  anak: {
    ...
    facts: [
      { id: "Galaksi Bima Sakti diciptakan dengan keunikan dan manfaat yang sangat besar.", en: "Galaksi Bima Sakti was created with unique traits and immense benefits." },
      { id: "Allah menyebut Galaksi Bima Sakti dalam Al-Qur'an agar manusia mengamati sains di baliknya.", en: "Allah mentions Galaksi Bima Sakti in the Qur'an so humans observe the science behind it." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban sains dan wahyu yang sesuai: Allah menyebut Galaksi Bima Sakti di Al-Qur'an ribuan tahun sebelum sains modern meneliti keunikan fungsionalnya.",
      en: "The alignment of science and revelation: Allah mentioned Galaksi Bima Sakti in the Qur'an thousands of years before modern science researched its functional uniqueness.",
    },
    quranVerse: {
