...
export const marsData: ObjectData = {
  ...
  balita: {
    text: {
      id: "Ini Mars! Ciptaan Allah yang luar biasa indah. 🌟",
      en: "This is Mars! An amazingly beautiful creation of Allah. 🌟",
    },
    audioTranscript: {
      id: "Ini Mars. Allah menciptakan Mars dengan sangat baik agar kita semua bersyukur.",
      en: "This is Mars. Allah created Mars beautifully so we all become grateful.",
    },
    quiz: {
      question: {
        id: "Mana gambar Mars?",
        en: "Which one is the picture of Mars?",
      },
      options: [
  ...
  anak: {
    text: {
      id: "Fakta menarik tentang Mars: Merupakan bukti keagungan penciptaan Allah di alam semesta.",
    ...
    quiz: {
      question: {
        id: "Siapa yang menciptakan Mars dengan sempurna?",
        en: "Who created Mars perfectly?",
      },
      options: [
  ...
  explorer: {
    text: {
      id: "Eksplorasi anatomi dan struktur Mars mengungkap kehebatan rancangan sistem biologi dan alam yang seimbang.",
    ...
    quiz: [
      {
        question: {
          id: "Apa hikmah utama diutusnya tanda sains tentang Mars?",
          en: "What is the primary wisdom of scientific signs regarding Mars?",
        },
        options: [
