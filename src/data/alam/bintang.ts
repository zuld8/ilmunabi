...
export const bintangData: ObjectData = {
  ...
  anak: {
    ...
    facts: [
      { id: "Bintang diciptakan dengan keunikan dan manfaat yang sangat besar.", en: "Bintang was created with unique traits and immense benefits." },
      { id: "Allah menyebut Bintang dalam Al-Qur'an agar manusia mengamati sains di baliknya.", en: "Allah mentions Bintang in the Qur'an so humans observe the science behind it." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban sains dan wahyu yang sesuai: Allah menyebut Bintang di Al-Qur'an ribuan tahun sebelum sains modern meneliti keunikan fungsionalnya.",
      en: "The alignment of science and revelation: Allah mentioned Bintang in the Qur'an thousands of years before modern science researched its functional uniqueness.",
    },
    quranVerse: {
