...
export const saljuData: ObjectData = {
  ...
  anak: {
    ...
    facts: [
      { id: "Salju diciptakan dengan keunikan dan manfaat yang sangat besar.", en: "Salju was created with unique traits and immense benefits." },
      { id: "Allah menyebut Salju dalam Al-Qur'an agar manusia mengamati sains di baliknya.", en: "Allah mentions Salju in the Qur'an so humans observe the science behind it." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban sains dan wahyu yang sesuai: Allah menyebut Salju di Al-Qur'an ribuan tahun sebelum sains modern meneliti keunikan fungsionalnya.",
      en: "The alignment of science and revelation: Allah mentioned Salju in the Qur'an thousands of years before modern science researched its functional uniqueness.",
    },
    quranVerse: {
