...
export const lautData: ObjectData = {
  ...
  anak: {
    ...
    facts: [
      { id: "Laut merupakan bagian dari sunnatullah (hukum alam) yang menjaga kestabilan energi di bumi.", en: "Laut merupakan bagian dari sunnatullah (hukum alam) yang menjaga kestabilan energi di bumi." },
      { id: "Keteraturan siklus Laut memungkinkan kehidupan biologis manusia berjalan dengan aman.", en: "Keteraturan siklus Laut memungkinkan kehidupan biologis manusia berjalan dengan aman." },
      { id: "Interaksi fisik Laut dengan unsur bumi lainnya menciptakan keindahan alam yang tak terhingga.", en: "Interaksi fisik Laut dengan unsur bumi lainnya menciptakan keindahan alam yang tak terhingga." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban penciptaan Laut: Allah SWT menyeimbangkan gaya gravitasi, suhu, dan rotasi bumi dengan Laut agar tidak terjadi benturan atau kehancuran kosmis.",
      en: "Keajaiban penciptaan Laut: Allah SWT menyeimbangkan gaya gravitasi, suhu, dan rotasi bumi dengan Laut agar tidak terjadi benturan atau kehancuran kosmis.",
    },
    quranVerse: {
