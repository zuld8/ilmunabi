...
export const adamAsData: NabiData = {
  ...
  storyShort: {
    id: "Manusia pertama yang diciptakan Allah SWT dari tanah liat.",
    en: "The first human created by Allah SWT from clay."
  },
  storyFull: {
    id: "Allah menciptakan Nabi Adam AS dari tanah liat, lalu meniupkan roh kepadanya. Beliau diberi pengetahuan tentang nama-nama semua benda yang bahkan para malaikat tidak mengetahuinya. Setelah sempat tinggal di surga, Nabi Adam dan Hawa diturunkan ke bumi untuk menjadi khalifah. Ini mengajarkan kita bahwa manusia adalah makhluk istimewa yang dibekali akal untuk memakmurkan bumi.",
    en: "Allah created Prophet Adam AS from clay, then breathed a soul into him. He was taught the names of all things, something even angels did not know. After briefly living in heaven, Adam and Eve were sent to earth as vicegerents. This teaches us that humans are special creatures equipped with intellect to prosper on earth."
  },
  miracles: [
    { id: "Manusia pertama yang diciptakan tanpa ayah dan ibu.", en: "The first human created without a father and a mother." },
    { id: "Diberi ilmu oleh Allah untuk mengetahui nama-nama segala sesuatu.", en: "Given knowledge by Allah to know the names of all things." }
  ],
  characterTraits: [
    ...
    { trait: { id: "Bertanggung Jawab", en: "Responsible" }, desc: { id: "Menjalankan tugas sebagai khalifah di bumi dengan baik.", en: "Carrying out the duty as a vicegerent on earth well." } }
  ],
  timeline: [
  ...
  dailyLifeConnection: {
    id: "Gunakan akal kita untuk rajin belajar, seperti Nabi Adam yang mengetahui nama semua benda. Kalau buat salah, langsung bilang maaf!",
    en: "Use our intellect to study diligently, like Prophet Adam who knew the names of all things. If you make a mistake, say sorry immediately!"
  }
};
