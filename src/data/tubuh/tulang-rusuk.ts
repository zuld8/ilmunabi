...
export const tulangRusukData: ObjectData = {
  ...
  anak: {
    ...
    facts: [
      { id: "Tulang Rusuk diciptakan dengan keunikan dan manfaat yang sangat besar.", en: "Tulang Rusuk was created with unique traits and immense benefits." },
      { id: "Allah menyebut Tulang Rusuk dalam Al-Qur'an agar manusia mengamati sains di baliknya.", en: "Allah mentions Tulang Rusuk in the Qur'an so humans observe the science behind it." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban sains dan wahyu yang sesuai: Allah menyebut Tulang Rusuk di Al-Qur'an ribuan tahun sebelum sains modern meneliti keunikan fungsionalnya.",
      en: "The alignment of science and revelation: Allah mentioned Tulang Rusuk in the Qur'an thousands of years before modern science researched its functional uniqueness.",
    },
    quranVerse: {
