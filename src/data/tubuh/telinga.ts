...
export const telingaData: ObjectData = {
  ...
  anak: {
    ...
    facts: [
      { id: "Telinga diciptakan dengan keunikan dan manfaat yang sangat besar.", en: "Telinga was created with unique traits and immense benefits." },
      { id: "Allah menyebut Telinga dalam Al-Qur'an agar manusia mengamati sains di baliknya.", en: "Allah mentions Telinga in the Qur'an so humans observe the science behind it." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban sains dan wahyu yang sesuai: Allah menyebut Telinga di Al-Qur'an ribuan tahun sebelum sains modern meneliti keunikan fungsionalnya.",
      en: "The alignment of science and revelation: Allah mentioned Telinga in the Qur'an thousands of years before modern science researched its functional uniqueness.",
    },
    quranVerse: {
