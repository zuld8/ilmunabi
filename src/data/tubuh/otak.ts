...
export const otakData: ObjectData = {
  ...
  anak: {
    ...
    facts: [
      { id: "Otak diciptakan dengan keunikan dan manfaat yang sangat besar.", en: "Otak was created with unique traits and immense benefits." },
      { id: "Allah menyebut Otak dalam Al-Qur'an agar manusia mengamati sains di baliknya.", en: "Allah mentions Otak in the Qur'an so humans observe the science behind it." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban sains dan wahyu yang sesuai: Allah menyebut Otak di Al-Qur'an ribuan tahun sebelum sains modern meneliti keunikan fungsionalnya.",
      en: "The alignment of science and revelation: Allah mentioned Otak in the Qur'an thousands of years before modern science researched its functional uniqueness.",
    },
    quranVerse: {
