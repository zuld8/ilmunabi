...
export const darahData: ObjectData = {
  ...
  balita: {
    text: {
      id: "Ini Darah! Ciptaan Allah yang luar biasa indah. 🌟",
      en: "This is Darah! An amazingly beautiful creation of Allah. 🌟",
    },
    audioTranscript: {
      id: "Ini Darah. Allah menciptakan Darah dengan sangat baik agar kita semua bersyukur.",
      en: "This is Darah. Allah created Darah beautifully so we all become grateful.",
    },
    quiz: {
      question: {
        id: "Mana gambar Darah?",
        en: "Which one is the picture of Darah?",
      },
      options: [
        { text: { id: "🩸 Darah", en: "🩸 Darah" } },
  ...
  anak: {
    text: {
      id: "Fakta menarik tentang Darah: Merupakan bukti keagungan penciptaan Allah di alam semesta.",
    ...
    quiz: {
      question: {
        id: "Siapa yang menciptakan Darah dengan sempurna?",
        en: "Who created Darah perfectly?",
      },
      options: [
  ...
  explorer: {
    text: {
      id: "Eksplorasi anatomi dan struktur Darah mengungkap kehebatan rancangan sistem biologi dan alam yang seimbang.",
    ...
    quiz: [
      {
        question: {
          id: "Apa hikmah utama diutusnya tanda sains tentang Darah?",
          en: "What is the primary wisdom of scientific signs regarding Darah?",
        },
        options: [
