...
export const anatomiUnik1Data: ObjectData = {
  slug: "anatomi-unik-1",
  name: {
    id: "Anatomi Unik 1",
    en: "Anatomi Unik 1",
  ...
  balita: {
    text: {
      id: "Ini Anatomi Unik 1! Ciptaan Allah yang luar biasa indah. 🌟",
      en: "This is Anatomi Unik 1! An amazingly beautiful creation of Allah. 🌟",
    },
    audioTranscript: {
      id: "Ini Anatomi Unik 1. Allah menciptakan Anatomi Unik 1 dengan sangat baik agar kita semua bersyukur.",
      en: "This is Anatomi Unik 1. Allah created Anatomi Unik 1 beautifully so we all become grateful.",
    },
    quiz: {
      question: {
        id: "Mana gambar Anatomi Unik 1?",
        en: "Which one is the picture of Anatomi Unik 1?",
      },
      options: [
        { text: { id: "🦴 Anatomi Unik 1", en: "🦴 Anatomi Unik 1" } },
  ...
  anak: {
    text: {
      id: "Fakta menarik tentang Anatomi Unik 1: Merupakan bukti keagungan penciptaan Allah di alam semesta.",
    ...
    quiz: {
      question: {
        id: "Siapa yang menciptakan Anatomi Unik 1 dengan sempurna?",
        en: "Who created Anatomi Unik 1 perfectly?",
      },
      options: [
  ...
  explorer: {
    text: {
      id: "Eksplorasi anatomi dan struktur Anatomi Unik 1 mengungkap kehebatan rancangan sistem biologi dan alam yang seimbang.",
    ...
    quiz: [
      {
        question: {
          id: "Apa hikmah utama diutusnya tanda sains tentang Anatomi Unik 1?",
          en: "What is the primary wisdom of scientific signs regarding Anatomi Unik 1?",
        },
        options: [
