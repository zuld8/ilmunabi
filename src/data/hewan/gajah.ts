...
export const gajahData: ObjectData = {
  ...
  anak: {
    ...
    facts: [
      { id: "Gajah memiliki keunikan fisik dan perilaku yang membuktikan kesempurnaan ciptaan Allah SWT.", en: "Gajah memiliki keunikan fisik dan perilaku yang membuktikan kesempurnaan ciptaan Allah SWT." },
      { id: "Setiap sel dan organ tubuh Gajah bekerja dalam keseimbangan ekosistem yang luar biasa.", en: "Setiap sel dan organ tubuh Gajah bekerja dalam keseimbangan ekosistem yang luar biasa." },
      { id: "Allah SWT menciptakan Gajah dengan peran dan manfaat khusus yang sangat bernutrisi atau berguna bagi manusia.", en: "Allah SWT menciptakan Gajah dengan peran dan manfaat khusus yang sangat bernutrisi atau berguna bagi manusia." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban penciptaan Gajah: Allah SWT merancang sistem sensorik, anatomi, dan insting bertahan hidup pada Gajah dengan presisi tinggi agar seimbang dengan alam sekitarnya.",
      en: "Keajaiban penciptaan Gajah: Allah SWT merancang sistem sensorik, anatomi, dan insting bertahan hidup pada Gajah dengan presisi tinggi agar seimbang dengan alam sekitarnya.",
    },
    quranVerse: {
