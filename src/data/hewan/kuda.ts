...
export const kudaData: ObjectData = {
  ...
  anak: {
    ...
    facts: [
      { id: "Kuda memiliki keunikan fisik dan perilaku yang membuktikan kesempurnaan ciptaan Allah SWT.", en: "Kuda memiliki keunikan fisik dan perilaku yang membuktikan kesempurnaan ciptaan Allah SWT." },
      { id: "Setiap sel dan organ tubuh Kuda bekerja dalam keseimbangan ekosistem yang luar biasa.", en: "Setiap sel dan organ tubuh Kuda bekerja dalam keseimbangan ekosistem yang luar biasa." },
      { id: "Allah SWT menciptakan Kuda dengan peran dan manfaat khusus yang sangat bernutrisi atau berguna bagi manusia.", en: "Allah SWT menciptakan Kuda dengan peran dan manfaat khusus yang sangat bernutrisi atau berguna bagi manusia." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban penciptaan Kuda: Allah SWT merancang sistem sensorik, anatomi, dan insting bertahan hidup pada Kuda dengan presisi tinggi agar seimbang dengan alam sekitarnya.",
      en: "Keajaiban penciptaan Kuda: Allah SWT merancang sistem sensorik, anatomi, dan insting bertahan hidup pada Kuda dengan presisi tinggi agar seimbang dengan alam sekitarnya.",
    },
    quranVerse: {
