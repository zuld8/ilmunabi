...
export const lalatData: ObjectData = {
  ...
  anak: {
    ...
    facts: [
      { id: "Lalat memiliki keunikan fisik dan perilaku yang membuktikan kesempurnaan ciptaan Allah SWT.", en: "Lalat memiliki keunikan fisik dan perilaku yang membuktikan kesempurnaan ciptaan Allah SWT." },
      { id: "Setiap sel dan organ tubuh Lalat bekerja dalam keseimbangan ekosistem yang luar biasa.", en: "Setiap sel dan organ tubuh Lalat bekerja dalam keseimbangan ekosistem yang luar biasa." },
      { id: "Allah SWT menciptakan Lalat dengan peran dan manfaat khusus yang sangat bernutrisi atau berguna bagi manusia.", en: "Allah SWT menciptakan Lalat dengan peran dan manfaat khusus yang sangat bernutrisi atau berguna bagi manusia." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban penciptaan Lalat: Allah SWT merancang sistem sensorik, anatomi, dan insting bertahan hidup pada Lalat dengan presisi tinggi agar seimbang dengan alam sekitarnya.",
      en: "Keajaiban penciptaan Lalat: Allah SWT merancang sistem sensorik, anatomi, dan insting bertahan hidup pada Lalat dengan presisi tinggi agar seimbang dengan alam sekitarnya.",
    },
    quranVerse: {
