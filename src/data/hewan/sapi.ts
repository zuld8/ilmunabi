...
export const sapiData: ObjectData = {
  ...
  anak: {
    ...
    facts: [
      { id: "Sapi memiliki keunikan fisik dan perilaku yang membuktikan kesempurnaan ciptaan Allah SWT.", en: "Sapi memiliki keunikan fisik dan perilaku yang membuktikan kesempurnaan ciptaan Allah SWT." },
      { id: "Setiap sel dan organ tubuh Sapi bekerja dalam keseimbangan ekosistem yang luar biasa.", en: "Setiap sel dan organ tubuh Sapi bekerja dalam keseimbangan ekosistem yang luar biasa." },
      { id: "Allah SWT menciptakan Sapi dengan peran dan manfaat khusus yang sangat bernutrisi atau berguna bagi manusia.", en: "Allah SWT menciptakan Sapi dengan peran dan manfaat khusus yang sangat bernutrisi atau berguna bagi manusia." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban penciptaan Sapi: Allah SWT merancang sistem sensorik, anatomi, dan insting bertahan hidup pada Sapi dengan presisi tinggi agar seimbang dengan alam sekitarnya.",
      en: "Keajaiban penciptaan Sapi: Allah SWT merancang sistem sensorik, anatomi, dan insting bertahan hidup pada Sapi dengan presisi tinggi agar seimbang dengan alam sekitarnya.",
    },
    quranVerse: {
