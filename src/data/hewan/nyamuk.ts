...
export const nyamukData: ObjectData = {
  ...
  anak: {
    ...
    facts: [
      { id: "Nyamuk memiliki keunikan fisik dan perilaku yang membuktikan kesempurnaan ciptaan Allah SWT.", en: "Nyamuk memiliki keunikan fisik dan perilaku yang membuktikan kesempurnaan ciptaan Allah SWT." },
      { id: "Setiap sel dan organ tubuh Nyamuk bekerja dalam keseimbangan ekosistem yang luar biasa.", en: "Setiap sel dan organ tubuh Nyamuk bekerja dalam keseimbangan ekosistem yang luar biasa." },
      { id: "Allah SWT menciptakan Nyamuk dengan peran dan manfaat khusus yang sangat bernutrisi atau berguna bagi manusia.", en: "Allah SWT menciptakan Nyamuk dengan peran dan manfaat khusus yang sangat bernutrisi atau berguna bagi manusia." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban penciptaan Nyamuk: Allah SWT merancang sistem sensorik, anatomi, dan insting bertahan hidup pada Nyamuk dengan presisi tinggi agar seimbang dengan alam sekitarnya.",
      en: "Keajaiban penciptaan Nyamuk: Allah SWT merancang sistem sensorik, anatomi, dan insting bertahan hidup pada Nyamuk dengan presisi tinggi agar seimbang dengan alam sekitarnya.",
    },
    quranVerse: {
