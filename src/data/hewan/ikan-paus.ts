...
export const ikanPausData: ObjectData = {
  ...
  anak: {
    ...
    facts: [
      { id: "Ikan Paus memiliki keunikan fisik dan perilaku yang membuktikan kesempurnaan ciptaan Allah SWT.", en: "Ikan Paus memiliki keunikan fisik dan perilaku yang membuktikan kesempurnaan ciptaan Allah SWT." },
      { id: "Setiap sel dan organ tubuh Ikan Paus bekerja dalam keseimbangan ekosistem yang luar biasa.", en: "Setiap sel dan organ tubuh Ikan Paus bekerja dalam keseimbangan ekosistem yang luar biasa." },
      { id: "Allah SWT menciptakan Ikan Paus dengan peran dan manfaat khusus yang sangat bernutrisi atau berguna bagi manusia.", en: "Allah SWT menciptakan Ikan Paus dengan peran dan manfaat khusus yang sangat bernutrisi atau berguna bagi manusia." }
    ],
    quranVerse: {
  ...
  explorer: {
    ...
    wowFactor: {
      id: "Keajaiban penciptaan Ikan Paus: Allah SWT merancang sistem sensorik, anatomi, dan insting bertahan hidup pada Ikan Paus dengan presisi tinggi agar seimbang dengan alam sekitarnya.",
      en: "Keajaiban penciptaan Ikan Paus: Allah SWT merancang sistem sensorik, anatomi, dan insting bertahan hidup pada Ikan Paus dengan presisi tinggi agar seimbang dengan alam sekitarnya.",
    },
    quranVerse: {
